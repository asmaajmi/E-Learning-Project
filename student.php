...
if (isset($_POST['email'])) {
    ...
    if($exist>=1){  
        ...
        $role = "Student";
        $sql1 = "INSERT INTO user (id, first_name, last_name, email, phone, gender, birthdate, role, country, password, degree) VALUES (NULL, :first_name, :last_name, :email, :phone, :gender, :birthdate, :role, :country, :password, :degree);";
        ...
        $query->bindValue(':degree', $_POST['degree']);
        $ex=$query->execute();
            if($ex)
            {
              ...
              <form method="POST" action="student.php">
                ...
                <div class="form-row">
                    ...
                    <select name="degree" class="form-select">
                      <option selected>Select Your Level Of Study</option>
                      <option value="7th degree"> 7th degree </option>
                      <option value="8th degree"> 8th degree</option>
                      <option value="9th degree"> 9th degree </option>
