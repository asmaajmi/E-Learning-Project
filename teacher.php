...
if (isset($_POST['email'])) {
    ...
    if($exist>=1){  
        ...
        $role = "Teacher";
        $sql1 = "INSERT INTO user (id, first_name, last_name, email, phone, gender, birthdate, role, country, password, id_matiere) VALUES (NULL, :first_name, :last_name, :email, :phone, :gender, :birthdate, :role, :country, :password, :id_matiere);";
        ...
        $query->bindValue(':id_matiere', $_POST['id_matiere']);
        $ex=$query->execute();
            if($ex)
            {
